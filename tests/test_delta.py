...
def test_diff_accepts_multiple_formats(other, expected):
    ...
    if isinstance(other, str):
        ...
        d2 = Date(datetime(other["year"], other["month"], other["day"], tzinfo=ZoneInfo("UTC")), tz="UTC")
...
@pytest.mark.parametrize("start, end, unit, expected", [
    (datetime(2024, 1, 1, tzinfo=ZoneInfo("UTC")), datetime(2025, 1, 3, tzinfo=ZoneInfo("UTC")), "days", 368),
    (datetime(2024, 1, 1, tzinfo=ZoneInfo("UTC")), datetime(2025, 1, 3, tzinfo=ZoneInfo("UTC")), "months", 12),
    (datetime(2024, 1, 1, tzinfo=ZoneInfo("UTC")), datetime(2025, 1, 3, tzinfo=ZoneInfo("UTC")), "years", 1),
])
